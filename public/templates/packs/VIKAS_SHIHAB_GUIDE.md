...
- **Shihab premium page:** `/templates/packs/business-plan-executive-summary/index.html`  
  (autosave, dynamic tables, validation, print — use this density on every pack page)
