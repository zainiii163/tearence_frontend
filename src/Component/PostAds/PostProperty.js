...
import { FaArrowLeft, FaImage, FaDollarSign, FaCheck, FaExclamationTriangle, FaTimes, FaHome } from "react-icons/fa";
...
function PostProperty() {
  ...
  const onSubmit = async (item) => {
    ...
    try {
      ...
      toast.success("Your property post is created");
      navigate("/");
    } catch (error) {
      alert(error);
    }
            ...
            <div className="container mx-auto px-4">
              <div className="text-center">
                <h1 className="text-4xl font-bold text-white mb-4">
                  Post New Property Ad
                </h1>
                <p className="text-blue-100 text-lg">
                  Create your property listing for sale or rent
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="rounded-lg border bg-card shadow-sm p-6">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Fill in your property information</p>
                    </div>
                  </div>
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="e.g., Swimming pool, gym, security, garden, etc."
                        onChange={handleChange}
                        rows="3"
                    ...
                    <div>
                      ...
                      <div className="border border-input rounded-md">
                        <ReactQuill
                          ...
                          theme="snow"
                          placeholder="Describe your property in detail including features, location benefits, nearby amenities, etc..."
                        />
                      </div>
                    </div>
                  </div>
