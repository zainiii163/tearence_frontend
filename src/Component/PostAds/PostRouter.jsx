...
const PostRouter = () => {
  ...
  React.useEffect(() => {
    ...
    const redirects = {
      ...
      affiliates: '/affiliates/marketplace?postForm=true&mode=business',
      ...
      'banner-ads': '/banner-adverts?postForm=true',
      'banner-adverts': '/banner-adverts?postForm=true',
      banners: '/banner-adverts?postForm=true',
      software: '/software',
