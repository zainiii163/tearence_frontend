...
import { getPromotedAdsModern } from "../slice/ListSlice";

const PromotedAdsPage = () => {
  return (
    <ModernCategoryPage
      categoryType="promoted-ads"
      getDataAction={getPromotedAdsModern}
      dataSelector={(store) => store.ads.promotedAds?.data || { items: [], total: 0 }}
