...
const VehicleItem = memo(({ item, viewMode = "grid", onUpsellClick }) => {
  ...
  const formatMileage = (mileage) => {
    ...
    if (mileage >= 1000) {
      return `${(mileage / 1000).toFixed(0)}k miles`;
    }
        ...
        <div className="flex flex-col md:flex-row gap-4 p-6">
          ...
          <div className="flex-1 space-y-3">
            ...
            <div className="flex items-center gap-2">
              ...
              {item.condition && (
                <div className={`inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors border-transparent ${getConditionColor(item.condition)}`}>
        ...
        {showUpsellModal && onUpsellClick && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
              <h3 className="text-lg font-semibold mb-4">Promote Your Vehicle</h3>
              <p className="text-gray-600 mb-4">Choose how you want to promote your vehicle listing:</p>
