...
export const LIVE_SOFTWARE_PRODUCTS = [
  ...
  {
    id: 'live-wp-booking-plugin',
    title: 'WordPress Booking Calendar Plugin',
    category: 'plugins',
    price: 29,
    sales: 240,
    rating: 4.7,
    ...
    framework: 'WordPress',
    language: 'PHP',
    downloadUrl: '/downloads/software/wwa-wp-booking-readme.txt',
    previewUrl: '/downloads/software/previews/wp-site-notice.html',
    image:
      'https://images.unsplash.com/photo-1506784983877-45594efa4cbe?auto=format&fit=crop&w=800&q=80',
    description:
      'Appointment slots, email confirmations and a simple admin calendar — drop into any WordPress site.',
  },
  {
    id: 'live-react-native-starter',
    title: 'React Native Shop Starter',
    ...
    language: 'JavaScript',
    downloadUrl: '/downloads/software/samples/rn-shop-readme.txt',
    image:
      'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?auto=format&fit=crop&w=800&q=80',
    description:
      'Mobile shop UI kit: product grid, cart and checkout screens ready to wire to your API.',
  },
  {
    id: 'live-ui-kit-marketplace',
    title: 'Marketplace UI Kit (Figma + CSS)',
    category: 'ui-kits',
    price: 34,
    sales: 390,
    rating: 4.8,
    ...
    framework: 'HTML/CSS',
    language: 'CSS',
    downloadUrl: '/downloads/software/samples/ui-kit-readme.txt',
    image:
      'https://images.unsplash.com/photo-1561070791-2526d30994b5?auto=format&fit=crop&w=800&q=80',
    description:
      'Card, filter and listing components for classified and marketplace products — CSS tokens included.',
  },
  {
    id: 'live-saas-billing-snippet',
    title: 'SaaS Billing Snippet Pack',
    category: 'saas',
    price: 45,
    sales: 112,
    rating: 4.5,
    ...
    framework: 'Node.js',
    language: 'JavaScript',
    downloadUrl: '/downloads/software/samples/saas-billing-readme.txt',
    image:
      'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=800&q=80',
    description:
      'Subscription plan cards, invoice PDF stub and webhook checklist for a simple SaaS billing flow.',
  },
  {
