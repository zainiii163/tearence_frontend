    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">You need to be logged in to access affiliate dashboard.</p>
          <Link 
            to="/login" 
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{userDetail?.name || "Affiliate"}</p>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-4">
      ...
      <div className="page-container py-8">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-lg p-6 mb-8 text-white">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold mb-2">Welcome back, {userDetail?.name || 'Affiliate'}!</h2>
              <p className="opacity-90">Here's what's happening with your affiliate business today.</p>
            </div>
            <div className="flex items-center space-x-4">
              <div className="text-center">
                <FaRocket className="h-8 w-8 mb-2" />
                <p className="text-sm">Level {Math.floor((dashboardData.stats.totalBusinessOffers + dashboardData.stats.totalUserPosts) / 5) + 1}</p>
              </div>
              <div className="text-center">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                      ...
                      <div className="text-center p-6 bg-emerald-50 rounded-lg">
                        ...
                        <p className="text-2xl font-bold text-emerald-900">${dashboardData.stats.totalRevenue.toFixed(2)}</p>
