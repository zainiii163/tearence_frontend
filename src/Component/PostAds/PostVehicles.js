...
import { FaArrowLeft, FaImage, FaDollarSign, FaCheck, FaExclamationTriangle, FaTimes, FaCar } from "react-icons/fa";
...
function PostVehicles() {
  ...
  const onSubmit = async (item) => {
    ...
    try {
      ...
      toast.success("Your vehicle post is created");
      navigate("/");
    } catch (error) {
      alert(error);
    }
            ...
            <div className="container mx-auto px-4">
              <div className="text-center">
                ...
                <p className="text-blue-100 text-lg">
                  Create your vehicle listing and reach thousands of potential buyers
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="rounded-lg border bg-card shadow-sm p-6">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Fill in your vehicle information</p>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Enter a descriptive title for your vehicle"
                    ...
                    <div>
                      ...
                      <div className="border border-input rounded-md">
                        <ReactQuill
                          ...
                          theme="snow"
                          placeholder="Describe your vehicle in detail including features, maintenance history, etc..."
                        />
                      </div>
                    </div>
                  </div>
