...
export const TravelAuthProvider = ({ children }) => {
  ...
  const login = async (credentials) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_BASE_URL || process.env.REACT_APP_API_URL || 'https://api.worldwideadverts.info/api/v1'}/auth/web-login`, {
        method: 'POST',
        headers: {
  ...
  const register = async (userData) => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_API_BASE_URL || process.env.REACT_APP_API_URL || 'https://api.worldwideadverts.info/api/v1'}/auth/register`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
