...
const TravelHero = ({ onSearch }) => {
  ...
  const stats = [
    { icon: Hotel, label: '15,234', sublabel: 'Resorts & Hotels' },
    { icon: Car, label: '8,456', sublabel: 'Transport Services' },
    { icon: Globe, label: '142', sublabel: 'Countries' },
    { icon: Users, label: '98%', sublabel: 'Satisfaction' }
  ];

  const categories = [
    { name: 'Luxury Resorts', icon: '🏰' },
  ...
  return (
    <>
      {/* Main Hero Section */}
      <div className="relative h-[600px] bg-gradient-to-br from-blue-900 via-blue-800 to-teal-700 overflow-hidden">
        {/* Background Pattern */}
        ...
        <motion.div
          ...
          className="absolute bottom-20 right-10 text-white/20 text-6xl"
        >
          <Hotel />
        </motion.div>
        ...
        <div className="relative z-10 h-full flex items-center justify-center px-4">
          ...
          >
            ...
            >
              ...
              <span className="block text-3xl md:text-4xl mt-2 text-blue-200">Worldwide</span>
            </motion.h1>
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full mt-4 bg-gradient-to-r from-blue-600 to-teal-600 text-white py-4 rounded-lg font-semibold hover:from-blue-700 hover:to-teal-700 transition-all duration-300 flex items-center justify-center space-x-2"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
            {categories.map((category, index) => (
              ...
              >
                ...
                <span className="text-sm text-gray-700 group-hover:text-blue-600 font-medium">{category.name}</span>
              </motion.button>
            ))}
          </div>
        </div>
