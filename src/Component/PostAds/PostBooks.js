...
import { FaArrowLeft, FaImage, FaDollarSign, FaCheck, FaExclamationTriangle, FaTimes, FaBook } from "react-icons/fa";
...
function PostBooks() {
  ...
  const handleSubmit = async (e) => {
    ...
    // For "swap" books, price is not required
    if (formState.book_type !== "for_swap" && (formState.currency_id === 0 || formState.price === "")) {
  ...
  const onSubmit = async (item) => {
    ...
    const payload = {
      ...
      currency_id: formState.book_type === "for_swap" ? 0 : parseInt(formState.currency_id),
    ...
    try {
      ...
      toast.success("Your book post is created");
      navigate("/");
    } catch (error) {
      alert(error);
    }
            ...
            <div className="container mx-auto px-4">
              <div className="text-center">
                ...
                <p className="text-blue-100 text-lg">
                  Create your book listing for sale or swap
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="rounded-lg border bg-card shadow-sm p-6">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Fill in your book information</p>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Enter a descriptive title for your book"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          type="number"
                          name="year_published"
                          value={formState.year_published}
                    ...
                    {/* Price section - only show if not swap */}
                    {formState.book_type !== "for_swap" && (
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <label className="text-sm font-medium text-foreground mb-2 block">
                            Currency *
                    ...
                    <div>
                      ...
                      <div className="border border-input rounded-md">
                        <ReactQuill
                          ...
                          theme="snow"
                          placeholder="Describe your book in detail including plot summary, condition details, edition information, etc..."
                        />
                      </div>
                    </div>
                  </div>
