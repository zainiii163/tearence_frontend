...
const SIZES = [
  ...
  { id: '150x150', label: '150 × 150', name: 'Small Square', scale: 1 },
  { id: '200x400', label: '200 × 400', name: 'Half Page / Tall', scale: 1 },
  { id: '100x600', label: '100 × 600', name: 'Narrow Skyscraper', scale: 1 },
  { id: '100x400', label: '100 × 400', name: 'Narrow Tall', scale: 1 },
  { id: '100x200', label: '100 × 200', name: 'Narrow Button', scale: 1 },
