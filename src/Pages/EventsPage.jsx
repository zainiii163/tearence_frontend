...
import { FaMapMarkerAlt, FaSearch, FaFilter, FaStar, FaPhone, FaGlobe, FaUsers, FaDollarSign, FaHeart, FaShare, FaCalendarAlt, FaTicketAlt } from "react-icons/fa";
...
function EventsPage() {
  ...
  }, [currentPage, searchTerm, selectedType, selectedPriceRange, selectedCity, fetchVenues, activeTab]);
          ...
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <p className="text-purple-100 text-lg mb-8">
                Discover amazing venues and create unforgettable events
              </p>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all text-gray-900 placeholder-gray-500"
                        />
                      </div>
                    </div>
                    <div>
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="max-w-4xl mx-auto">
              <div className="bg-card border rounded-lg p-8 text-center">
                <FaCalendarAlt className="h-16 w-16 text-primary mx-auto mb-4" />
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button
                    onClick={() => navigate('/category/events/conference')}
                    className="inline-flex items-center justify-center rounded-md bg-primary text-primary-foreground hover:bg-primary/90 h-12 px-6 py-3 font-medium transition-colors"
                  >
                    <FaTicketAlt className="h-5 w-5 mr-2" />
                    Post Conference Event
                  </button>
                  <button
                    onClick={() => navigate('/category/events/concert')}
                    className="inline-flex items-center justify-center rounded-md bg-primary text-primary-foreground hover:bg-primary/90 h-12 px-6 py-3 font-medium transition-colors"
                  >
                    <FaTicketAlt className="h-5 w-5 mr-2" />
                    Post Concert Event
                  ...
                  <button
                    onClick={() => navigate('/category/events/festival')}
                    className="inline-flex items-center justify-center rounded-md bg-primary text-primary-foreground hover:bg-primary/90 h-12 px-6 py-3 font-medium transition-colors"
                  >
                    <FaTicketAlt className="h-5 w-5 mr-2" />
                    Post Festival Event
